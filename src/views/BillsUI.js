...
export default ({ data: bills, loading, error }) => {
  ...
  const modal = () => (`
    <div class="modal fade" id="modaleFileEmployee1" data-testid="modaleFileEmployee" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
